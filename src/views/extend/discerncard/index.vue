      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        >
          ...
          <el-table-column
            ...
            align="left"
          />
          <el-table-column prop="value4" label="住址"  align="left" />
          <el-table-column prop="value5" label="性别"  align="left" />
          <el-table-column prop="value6" label="民族"  align="left" />
          <el-table-column
            prop="value7"
            label="签发机关"
            align="left"
  ...
  data() {
    return {
      ...
      columnList: [
        ...
        { prop: "value7", label: "签发机关" },
        { prop: "value8", label: "有限期限" },
