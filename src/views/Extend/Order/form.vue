  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main order-form">
      <div class="JNPF-common-page-header">
        <el-page-header @back="goBack" :content="!dataForm.id ? '新建订单' : '编辑订单'" />
        <div class="options">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="订单编码">
                <el-input v-model="dataForm.orderCode" placeholder="订单编码" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
            ...
            <el-col :span="24">
              <el-form-item label="订单备注">
                <el-input v-model="dataForm.description" placeholder="订单备注" type="textarea"
                  :rows="3" />
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-tab-pane label="订单商品" name="goods">
              <el-table :data="list" size='mini' show-summary :summary-method="getSummaries">
                ...
                <el-table-column prop="discount" label="折扣%" width="90">
                  <template slot-scope="scope">
                    <!-- <el-input v-model="scope.row.discount" @change="count(scope.row)"
                      type="number"></el-input> -->
                    <el-input-number v-model="scope.row.discount" :precision="2" :step="0.1"
                      :min="0" :max="100" @change="count(scope.row)" controls-position="right">
                    </el-input-number>
                  </template>
                </el-table-column>
