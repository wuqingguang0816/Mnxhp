                  ...
                  <el-dropdown v-has="'btn_more'">
                    ...
                    <el-dropdown-menu slot="dropdown">
                      <el-dropdown-item v-if="scope.row.isButtonAuthorize === 1"
                        @click.native="handleButtonAuthorize(scope.row)" v-has="'btn_btnPer'">按钮权限
                      </el-dropdown-item>
                      <el-dropdown-item v-if="scope.row.isColumnAuthorize === 1"
                        @click.native="handleColumnAuthorize(scope.row)" v-has="'btn_columnPer'">
                        列表权限
                      </el-dropdown-item>
                      <el-dropdown-item v-if="scope.row.isDataAuthorize === 1"
                        @click.native="handleDataAuthorize(scope.row)" v-has="'btn_dataPer'">数据权限
                      </el-dropdown-item>
                    </el-dropdown-menu>
                  </el-dropdown>
                </template>
