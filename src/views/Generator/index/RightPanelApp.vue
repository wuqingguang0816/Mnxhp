          ...
          <template v-if="activeData.__config__">
            ...
            <template v-if="activeData.__config__.jnpfKey === 'JNPFText'">
              ...
              <el-form-item label="行高">
                <el-input-number v-model="activeData.lineHeight" :min="12" placeholder="请输入行高" /> px
              </el-form-item>
              <el-form-item label="字体大小">
                <el-input-number v-model="activeData.fontSize" :min="12" placeholder="请输入字体大小" /> px
              </el-form-item>
              <el-form-item label="对齐方式">
                <el-radio-group v-model="activeData['text-align']">
...
import { saveFormConf, getDrawingList } from "@/utils/generator/db"
