  ...
  computed: {
    formFieldsOptions() {
      ...
      const loop = (data, parent) => {
        ...
        if (data.__vModel__ && data.__config__.jnpfKey === 'date' && (data.__vModel__ !== this.activeData.__vModel__ || (data.__vModel__ == this.activeData.__vModel__ && data.__config__.relationTable))) {
