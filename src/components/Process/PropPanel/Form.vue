<template>
  <el-dialog :visible.sync="visible" class="JNPF-dialog JNPF-dialog_center" lock-scroll
    :title="!dataForm.id ? '新建' : '编辑'" :close-on-click-modal="false" width="1200px"
    :append-to-body="true">
    <div class="flow-form-main">
      <div class="JNPF-common-page-header">
        ...
        <div class="options">
          ...
          <el-button :disabled="dataForm.dataType!=2?active >= 2:active >= 1"
      ...
      <div class="jsStaticData" v-if="active === 2">
        <div class="json-box">
          <JNPFCodeEditor v-model="text" :options="options" ref="CodeEditor" class="json-box" />
        </div>
        <div class="jsTips">
      ...
      <div class="staticData" v-if="active === 1 && dataForm.dataType === 2">
        <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="100px">
          <el-form-item label-width="0" prop="query">
            <div class="json-box">
              <JSONEditor v-model="dataForm.query" style="height:100%" :options="jsonOptions"
                ref="JSONEditorRef" />
            </div>
          </el-form-item>
        </el-form>
