...
export function getDataInterfaceSelector() {
  return request({
    url: '/api/DataInterface/Selector',
    method: 'GET'
  })
}
...
export function updateDataInterfaceState(id) {
  return request({
    url: `/api/DataInterface/${id}/Actions/State`,
    method: 'PUT'
  })
}
...
export function previewDataInterface(id) {
  return request({
    url: `/api/DataInterface/${id}/Actions/Response`,
    method: 'GET'
  })
}