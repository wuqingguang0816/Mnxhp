<template>
  <div class="im-container" v-if="visible">
        ...
        <div class="chatList" ref="chatList">
          <div class="chatList-item" v-for="(item,index) in list" :key="index"
            ...
            <div class="chatList-text">
              ...
              <img :src="define.comUrl + item.message.path" alt="" class="chatList__msg--img"
                v-if="item.messageType=='image' && item.message.path"
                @click="handleEvent('image',define.comUrl + item.message.path)">
    ...
    <el-dialog :visible.sync="show" width="40%" append-to-body :before-close="handleClose"
      class="JNPF-dialog JNPF-dialog_center" lock-scroll style="z-index:2030">
...
.JNPF-dialog.JNPF-dialog_center >>> .el-dialog {
